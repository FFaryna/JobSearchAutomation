...
# Features
- Multi-source scraping: Aggregates job listings from RemoteOK and Remotive APIs [extensions as needed]
- Smart filtering: Filter jobs by keywords, tags, and minimum salary [to be improved as well, just proof of concept]
- Intelligent ranking: Scores jobs based on relevance to your criteria with source-weighted scoring [Implement AI to help with scoring]
- Deduplication: Removes duplicate job listings across sources and keeps the highest quality version
- User-friendly interface: Interactive command-line interface to specify your job search preferences [Proper UI tbd]
...
* TOP_OFFERS_COUNTS: Number of top results to display (default: 15) [could be moved to config]
...
The project is used to practice and refine skills obtained through structured course and play around with new concepts 
